...
function Footer() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed="-.2" className="w-full h-screen bg-zinc-800 flex text-white font-['founder'] border-t-[1px] border-zinc-700">
        <div className="w-1/2 p-[4vw] flex flex-col justify-between">
            <div>
                <h2 className="text-[9vw] uppercase leading-none">EYE-</h2>
                <h2 className="text-[9vw] uppercase leading-none">Opening</h2>
            </div>
        ...
        <div className="w-1/2 p-[4vw]">
            <div>
                <h2 className="text-[9vw] uppercase leading-none">PRESEntation</h2>
            </div>
            <div className="flex font-['montreal'] pt-10">
                <div className="w-1/2">
                    ...
                    <div className="flex flex-col gap-5 w-1/2 mt-5">
                        <p>L:</p>
                        <p className="underline block">202-1965 W 4th Ave Vancouver, Canada</p>
                        <p className="underline block">30 Chukarina St
                        Lviv, Ukraine</p>
                    </div>
                    <div className="flex flex-col gap-5 mt-5">
                        <p>E:</p>
                        <p className="underline block">hello@ochi.design</p>
                    </div>
                </div>
                <div className="w-1/2 flex flex-col justify-center items-end ">
                    <div className="w-1/2">
                        ...
                        {["Home","Services","Our Work","About us","Insights","Contact Us"].map((item,index) =>{
                            return <a key={index} href="#" className="block underline">{item}</a>
                        })}
                    </div>
                </div>
            </div>
